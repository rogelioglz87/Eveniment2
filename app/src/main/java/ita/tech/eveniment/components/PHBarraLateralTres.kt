...
@Composable
fun PHBarraLateralTres(procesoVM: ProcesoViewModel){
    ...
    Column(
        ...
        Text(text = procesoVM.fechaActualEspaniol, color = stateEveniment.color_texto, fontWeight = FontWeight.Bold, fontSize = P14_SIZE_FECHA.sp)
        // Wednesday, 03 September procesoVM.fechaActualIngles
        Text(text = procesoVM.fechaActualIngles, color = stateEveniment.color_texto, fontWeight = FontWeight.Bold, fontSize = P14_SIZE_FECHA.sp)
